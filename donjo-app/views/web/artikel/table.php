...
<div class="uibutton-group">
	...
	<a href="<?php echo site_url("web/ubah_kategori/$cat/$data[id]")?>" class="uibutton tipsy south" title="Ubah Kategori" target="ajax-modal" rel="window" header="Ubah Kategori" modalWidth="auto" modalHeight="auto"><span class="icon-question icon-large"></span></a>
